...
const INACTIVE_BUTTON = 'text-white font-bold py-1 px-4 rounded hover:bg-rose-400 hover:text-black';
const ACTIVE_BUTTON = 'text-black font-bold py-1 px-4 rounded bg-rose-400';
const PATHS = {
    home: '/',
    workouts: '/workouts',
    profile: '/profile'
